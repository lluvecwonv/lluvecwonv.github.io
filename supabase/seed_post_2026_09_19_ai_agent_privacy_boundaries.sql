...
VALUES ('2026-09-19-ai-agent-privacy-boundaries', 'AI 에이전트의 프라이버시, 격리된 공간과 데이터 흐름을 함께 설계하기', '2026-09-19', 'Medium의 에이전트 격리 화두를 간접 프롬프트 주입과 CaMeL 연구로 살펴보고, 실행 환경과 도구 권한을 구분해 점검한다.', ARRAY['AI','Agents','Privacy','Security','PromptInjection'], 'AI 소식', $post$
