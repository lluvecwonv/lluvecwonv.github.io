...
VALUES (
  '2026-03-29-does-learning-require-memorization',
  'Does Learning Require Memorization? A Short Tale about a Long Tail 논문 정리',
  '2026-03-29',
  'STOC 2020 논문. 자연 데이터의 long-tailed 분포에서 memorization이 최적 일반화를 위해 필수적임을 이론적으로 증명한 연구. Memorization 없이는 희귀 subpopulation에서의 성능 손실이 불가피하며, differential privacy와 model compression의 정확도 하락도 이 관점에서 설명한다.',
  ARRAY['LLM', 'Memorization', 'Long-tail', 'Generalization', 'Differential Privacy', 'STOC', '연구노트'],
  '연구노트',
...
INSERT INTO posts (slug, title, date, summary, tags, category, content, published, language)
VALUES (
  '2026-03-29-does-learning-require-memorization-en',
  'Does Learning Require Memorization? A Short Tale about a Long Tail - Paper Summary',
  '2026-03-29',
  'A STOC 2020 paper that theoretically proves memorization of training labels is necessary for achieving close-to-optimal generalization on natural long-tailed data distributions. The framework quantifies the cost of limiting memorization and explains the disparate accuracy impacts of differential privacy and model compression on minority subgroups.',
  ARRAY['LLM', 'Memorization', 'Long-tail', 'Generalization', 'Differential Privacy', 'STOC', 'Research Note'],
  '연구노트',
