-- PaperBanana Research Note (EN) seed SQL
-- Generated: 2026-03-10

INSERT INTO public.posts (slug, title, date, summary, tags, category, content, published, language)
VALUES (
  '2026-03-10-paperbanana-automating-academic-illustration-en',
  'PaperBanana: Automating Academic Illustration for AI Scientists — Paper Summary',
  '2026-03-10',
  ...
  ARRAY['Academic Illustration', 'Methodology Diagram', 'Statistical Plot', 'Multi-Agent', 'VLM', 'Image Generation', 'Agentic Framework', 'NeurIPS', 'Research Note'],
  '연구노트',
  $body$This research note summarizes the paper **PaperBanana: Automating Academic Illustration for AI Scientists** (arXiv:2601.23265).
...
- **SridBench (Related Benchmark)**: Chang et al., 2025 — arXiv:2505.22126$body$,
  true,
  'en'
)
