...
date: 2026-03-28
summary: "기존 RAG가 추론 집약적 태스크에 무효하다는 통념을 뒤집는 연구. 380B 단어 규모의 다양하고 고품질인 웹 스케일 데이터스토어 CompactDS를 구축하고, ANN+Exact Search 2단계 파이프라인으로 단일 노드에서 서브초 지연 검색을 달성. LLaMA 3.1 8B에서 MMLU +10%, MMLU Pro +33%, GPQA +14%, MATH +19% 향상. Google Search 기반 RAG를 능가하며, Search-o1 같은 복잡한 에이전틱 RAG 시스템에도 필적. NeurIPS 2025 투고 논문."
tags: [RAG, Retrieval, LLM, Datastore, Dense Retrieval, NeurIPS 2025, 연구노트]
category: 연구노트
language: ko
---
...
**학회:** NeurIPS 2025 (Preprint)
**저자:** Xinxi Lyu*, Michael Duan*, Rulin Shao, Pang Wei Koh, Sewon Min
**소속:** Allen Institute for AI (Ai2), UIUC, USC, University of Washington, UC Berkeley
...
### 6.3 QwQ 32B + Search-o1 비교 (Table 9)
