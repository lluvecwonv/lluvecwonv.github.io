...
![Figure 1. PaperBanana가 생성한 방법론 다이어그램과 통계 플롯 예시](/images/papers/paperbanana/figure1_examples.jpg)
...
![Figure 2. PaperBanana 프레임워크 전체 구조](/images/papers/paperbanana/figure2_framework.png)
...
![Figure 3. PaperBananaBench 통계 — 카테고리 분포 및 가로세로비](/images/papers/paperbanana/figure3_benchmark_stats.png)
...
![Table 1. PaperBananaBench 메인 결과](/images/papers/paperbanana/table1_main_results.png)
...
![Table 2. 어블레이션 스터디 결과](/images/papers/paperbanana/table2_ablation.png)
...
![Figure 4. 통계 플롯 생성 예시](/images/papers/paperbanana/figure4_stat_plots.png)
...
![Figure 5. 인간 작성 다이어그램의 미학 향상 예시](/images/papers/paperbanana/figure5_discussion_enhance.jpg)
...
![Figure 6. 코드 기반 vs. 이미지 생성 방식 비교](/images/papers/paperbanana/figure7_code_vs_img.jpg)
...
![Figure 7. 다이어그램 생성 케이스 스터디 — PaperBanana 출력 vs. 인간 참조](/images/papers/paperbanana/figure6_case_diagram.png)
